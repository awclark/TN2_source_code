...
class jsonprocesser:
    ...
    def __init__(self):
        ...
        data = json.dumps({"UserInfo":{"user id":self.client_mac,"timestamp":self.timestamp,"ip":"null","lat":0,"lon":0, "ISP":'NA'},
        ...
        print 'To view results enter to following text into 130.56.253.43:'
