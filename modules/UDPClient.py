...
class UDPClient:
    ...
    def UDP_Download_CBR(self, port, packet_size, no_of_packets, packets_per_sec):
        ...
        '''
        THis module is the video upload module with a constant bit rate transmission, it is unused in our main program
        '''
    ...
    def UDP_Upload_CBR(self, port, handler_port, packet_size, no_of_packets, packets_per_sec):
        ...
        This is the video upload modle designed to as a generalised bursty data source, it is unused
    ...
    This is the video upload module used in our project, it is made to mimic skype if you select the skype profile in main.py
    ...
    '''
    This is the download module with a bursty source
    '''
